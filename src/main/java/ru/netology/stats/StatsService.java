...
public class StatsService {
    public static void main(String[] args) {
        ...
        System.out.println("Сумма продаж за все месяцы: " + sum + " рублей");

        int averageSum = calculateAverageSum(purchases);
        System.out.println("Средняя сумма продаж за все месяцы: " + averageSum + " рублей");

        int maxSales = showMaxSales(purchases);
        System.out.println("Месяц с пиком продаж: " + maxSales);

        int minSales = showMinSales(purchases);
        System.out.println("Месяц с самым низким показателем продаж: " + minSales);
